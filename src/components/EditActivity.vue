<template>
    <div class="row justify-content-center">
        <div class="col-md-6">
            ...
            <LogActivity  :activity="activity" @update-activity="handleUpdateForm"/>
...
import LogActivity from '@/components/LogTime.vue'
...
export default {
    ...
    methods: {
        handleUpdateForm() {
            ...
            axios.put(apiURL, this.activity).then(() => {
        ...
        deleteActivity(){
            ...
            let indexOfArrayItem = this.Activities.findIndex(i => i._id === this.$route.params.id);
